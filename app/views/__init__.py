...
from .api_views import UserViewSet, GroupViewSet, ProjetoViewSet, get_projetos, get_placas_96, get_placas_1536, api_login_view, api_logout_view, DashboardAPIView
...
from .projeto_pdf_views import projeto_pdf_view
